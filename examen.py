...
def user_input_features():
  # Entrada
  estudio = st.number_input('Horas de estudio:', min_value=0.0, max_value=100.0, value = 0, step=1)
  sueño = st.number_input('Horas de estudio:',  min_value=0.0, max_value=24.0, value = 0, step=1)
  asistencia = st.number_input('Porcentaje de asistencia:', min_value=0.0, max_value=100.0, value = 0, step=1)
  anteriores = st.number_input('Resultado del examen anterior:', min_value=0.0, max_value=100.0, value = 0, step=1)
